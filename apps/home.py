...
def app():
    ...
    st.markdown('*Data Vision* is a Non-Governmental Organization fighting against data driven surveillance for civil liberties and digital rights. \
        ...
        This app runs **simulations** of data tracking software but does not affect the users\' privacy as the data is synthetic. \
    ...
    - [#DemandPrivacy Petition w/ OpenMedia](https://action.openmedia.org/page/95077/petition/1)
    - [#NoMobileTracking Petition w/ OpenMedia](https://action.openmedia.org/page/97956/action/1?ea.tracking.id=om)
